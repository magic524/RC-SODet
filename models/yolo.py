...
from models.block.v10.block import CIB, CIB2, C2fCIB, C2fCIB2, C2fRepCIB, C2fRepCIB2, RepCIB2
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args ###遍历yaml结构
        ...
        if m in {
            ...
            RepNCSPELAN4, SPPELAN,C2fCIB,DualConv,CIB,CIB2,C2fCIB2,C2fRepCIB,RepNCSPELAN6,DualConv2,RepCIB2,C2fRepCIB2}: ###
            c1, c2 = ch[f], args[0]
