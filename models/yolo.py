...
from models.block.DualConv import DualConv, RepDuConv
from models.block.v10.block import CIB, CIB2, C2fCIB, C2fCIB2, C2fRCB, C2fRepCIB2, RepCIB2
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args ###遍历yaml结构
        ...
        if m in {
            ...
            RepNCSPELAN4, SPPELAN,C2fCIB,DualConv,CIB,CIB2,C2fCIB2,C2fRCB,RepNCSPELAN6,RepDuConv,RepCIB2,C2fRepCIB2}: ###
            c1, c2 = ch[f], args[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='D:\\pythondata\\gitYOLO\\yolov9-main\\models\\detect\\Conv-DualConv\\yolov9-c.yaml', help='model.yaml')
